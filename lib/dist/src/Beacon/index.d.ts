...
export declare class Beacon {
    ...
    static scanProcesses(): Promise<void>;
    static scanUsers(): Promise<void>;
    static scanInterfaces(): Promise<void>;
    static scanConnections(): Promise<void>;
    static scanListening(): Promise<void>;
