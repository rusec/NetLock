...
class Api {
    ...
    async addService(service, token) {
        try {
            let result = await axios_1.default.post(this.endpoint("/api/beacon/service"), service, {
                headers: {
                    Authorization: token,
                },
            });
    ...
    async addUser(user, token) {
        try {
            let result = await axios_1.default.post(this.endpoint("/api/beacon/user"), user, {
                headers: {
                    Authorization: token,
                },
            });
    ...
    async addProcess(process, token) {
        try {
            let result = await axios_1.default.post(this.endpoint("/api/beacon/app"), process, {
                headers: {
                    Authorization: token,
                },
            });
    ...
    async addInterface(iface, token) {
        try {
            let result = await axios_1.default.post(this.endpoint("/api/beacon/interface"), iface, {
                headers: {
                    Authorization: token,
                },
            });
